...
## Also 
The database shows the posts/media even after a pod restarts/crashes ensuring persistence.
...
## For more details on metrics and alerting, refer to the [metrics design document](docs/metrics-design.md).
